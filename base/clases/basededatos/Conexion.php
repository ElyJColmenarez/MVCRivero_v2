...
class Conexion{
		/** @var String|null Nombre de la base de datos a conectarse */
		public static $baseDeDatos;
		/** @var String|null IP de la base de datos a conectarse */
		public static $host;
		/** @var String|null Usuario de la  base de datos a conectarse */
		public static $usuario;
		/** @var String|null CLave usuario de la  base de datos a conectarse */
		public static $clave;  
		/** @var String|null Puerto de la  base de datos a conectarse */
		...
		public static function conectar(){
			 try {
				...
				throw new Exception ("Datos de autenticación incorrectos, revise su usuario y contraseña");
			}
