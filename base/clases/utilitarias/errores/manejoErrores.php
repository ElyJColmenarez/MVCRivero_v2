 ...
 */
	...
	class manejoErrores{
		 ...
		 * @param string  $nombre 				Nombre o ruta del archivo a verificar.
		...
		public static function escribirExceptionJson(Exception $e){
			...
			vista::asignarDato("mensaje",$e->getMessage());
			Vista::mostrar();
		 ...
		 * 
		 * @param exception $e 				Exception a escribir
		 * @return String                   Cadena con los traces de la exception.
		 * 
		 */
		 ...
		 * 
		 * 
		 * @param Array $traces 				Exception a escribir
		 * @return String                       Traces a scribir.
		 * 
		 */
	    ...
	    /**
		 *  Funcion que permite buscar un error.
		 *
		 * Metodo que permite buscar un error en el archivo de errores
		 * mediante el codigo de error pasado por parametro.
		 * 
		 * 
		 * @param Integer $codError 	Codigo del error a buscar.
		 * @return Boolean               True si existe y false sino.
		 * 
		 */
		...
		/**
		 *  Funcion que permite obtener un error.
		 *
		 * Metodo que permite buscar un error en el archivo de errores
		 * mediante el codigo de error pasado por parametro.
		 * 
		 * 
		 * @param Integer $codError 	Codigo del error a buscar.
		 * @return String               Cadena con el error.
		 * 
		 */
