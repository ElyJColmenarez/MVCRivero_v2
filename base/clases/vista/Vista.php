 ...
 * importante del mvc.Algunas las funciones de esta clase relanzan las excepciones si son capturadas.
 ...
 */
	...
	class Vista {
		 /** @var String|null Módulo donde se encuentra la vista */
		public static $modulo;	
		/** @var String|null Formato en el cual se mostrara la vista */
		public static $formato;
		/** @var String|null Nombre de la vista que se va a mostrar. */
		public static $vista;
		/** @var [][]|null Datos que se quierenobtener en la vista. */
		public static $datos;
		/** @var String|null Nombre del archivo en caso de mandar a descargar uno. */
		public static $nombreArchivoDestino;
		
		/**
		 * Metodo que permite asignar el nombre del archivo destino.
		 *
		 *  Metodo que asigna el nombre del archivo destino al objeto Vista.
		 *
		 * @param string $nombre 		Nombre del archivo destino. 
		 *
		 ...
		 * @param array  $nombreArchivoDestino  Nombre dle achivo destino.
		 *
		 * @throws Exception 					Si se producen errores en validaciones para tipos de vista.
		 */
		 ...
		 *
		 * @param string $ruta 				Ruta dle archivo a verificar.
		...
		/**
		  * Muestra la vista en formato TXT
		  *
		  * Muestra una vista TXT, se le pasan los datos pertinentes y se obtiene la ruta.
		  *
		  */
