 ...
 * */	
	...
	function succConectar(data){
		if(data.estatus>0){
			permisos=data.login.permisos.permisos;
			console.log(permisos.AccionAgregar);
			...
			cadena="";
			if(permisos.InstitutoListar){
				cadena+="<li><a href='index.php?m_modulo=instituto&m_formato=html5&m_accion=listar&m_vista=Listar'>Institutos</a></li>";
				$(cadena).appendTo("#menuS2");
			}
			cadena="";
			if (permisos.AccionListar)
				cadena+="<li><a href='index.php?m_modulo=accion&m_formato=html5&m_accion=mostrar&m_vista=Mostrar'>Administrar acciones</a></li>";
			if (permisos.TablaListar)
				cadena+="<li><a href='javascript:AbrModTablas()'>Administrar tablas</a></li>";
			if (permisos.ModuloListar)
				cadena+="<li><a href='javascript:diaModulo()'>Administrar módulos</a></li>";
			if(permisos.UsuarioListar)
				cadena+="<li><a href='index.php?m_modulo=usuario&m_formato=html5&m_accion=filtrar&m_vista=Listar'>Administrar usuarios</a></li>";
			if(permisos.AdministrarPrivilegios)
				cadena+="<li><a href='index.php?m_modulo=usuario&m_formato=html5&m_accion=administrarPermisos&m_vista=AdministradorPermisos'>Administrar privilegios </a></li>";
			$(cadena).appendTo("#menuMVC");
