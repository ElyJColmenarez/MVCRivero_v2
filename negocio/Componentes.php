 ...
 */
class Componentes{
	/** @var String|null Version del PHP */
	public $verPhp;
	/** @var String|null Version del Postgres */
	public $verPostgres;
	/** @var Boolean|null Tiene Postgres */
	public $postgres;
	/** @var Boolean|null Tiene PDO */
	public $pdo;
	/** @var Boolean|null Tiene conector de Postgres con PHP */
	public $conPostgres;
	/** @var Boolean|null Tiene errores de php activos */
	public $disErrors;
	/** @var Boolean|null Tiene permisos de escritura sobre la carpeta */
	public $permisos;
