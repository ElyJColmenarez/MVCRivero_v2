...
class Sesion{
	...
	/**
	  * Funcion estatica que permite asignar el login(Objeto usuario) a la sesion .
	  *
	  * Permite iniciar la sesion con el login y los permisos para que se puedan utilizar 
	  * posteriormente y obtenerlo el login se refiere a un objeto usuario.
	  *
	  * @param object   $Usuario				Objetro usuario para guardar en la variable de sesion.
	  * 
      * @throws Exception 					Exception cuando el parametro no es Usuario.
	  */
	...
	/**
	  * Funcion estatica que permite obtener el login(Objeto usuario) de la sesion .
	  *
	  * Permite iniciar la sesion con el login y los permisos para que se puedan utilizar 
	  * posteriormente y obtenerlo el login se refiere a un objeto usuario.
	  *
